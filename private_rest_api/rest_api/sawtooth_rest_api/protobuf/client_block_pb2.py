...
_CLIENTBLOCKLISTREQUEST.fields_by_name['paging'].message_type = client__list__control__pb2._CLIENTPAGINGCONTROLS
_CLIENTBLOCKLISTREQUEST.fields_by_name['sorting'].message_type = client__list__control__pb2._CLIENTSORTCONTROLS
_CLIENTBLOCKLISTRESPONSE.fields_by_name['status'].enum_type = _CLIENTBLOCKLISTRESPONSE_STATUS
_CLIENTBLOCKLISTRESPONSE.fields_by_name['blocks'].message_type = block__pb2._BLOCK
_CLIENTBLOCKLISTRESPONSE.fields_by_name['paging'].message_type = client__list__control__pb2._CLIENTPAGINGRESPONSE
...
_CLIENTBLOCKGETRESPONSE.fields_by_name['block'].message_type = block__pb2._BLOCK
