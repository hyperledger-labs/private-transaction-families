...
def load_toml_rest_api_config(filename):
    ...
    invalid_keys = set(toml_config.keys()).difference(
        ['bind', 'connect', 'private_tp_url', 'timeout', 'opentsdb_db', 'opentsdb_url',
    ...
    config = RestApiConfig(
        ...
        private_tp_url=toml_config.get("private_tp_url", None),
...
def merge_rest_api_config(configs):
    ...
    for config in reversed(configs):
        ...
        if config.private_tp_url is not None:
            private_tp_url = config.private_tp_url
...
class RestApiConfig:
    ...
    @property
    def private_tp_url(self):
        return self._private_tp_url
    ...
    def __repr__(self):
        ...
        return \
            "{}(bind={}, connect={}, private_tp_url={}, timeout={}," \
    ...
    def to_dict(self):
        return collections.OrderedDict([
            ...
            ('private_tp_url', self._private_tp_url),
