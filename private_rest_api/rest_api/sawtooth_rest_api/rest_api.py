...
def parse_args(args):
    ...
    parser.add_argument('-U', '--private_tp_url',
                        help='specify URL to connect to private TP \
                        default: 127.0.0.1:36479')
...
def start_rest_api(host, port, connection, private_tp_url, timeout, registry,
    ...
    handler = RouteHandler(loop, connection, private_tp_url, timeout, registry)
...
def main():
    ...
    try:
        ...
        opts_config = RestApiConfig(
            ...
            private_tp_url = opts.private_tp_url,
        ...
        private_tp_url = rest_api_config.private_tp_url
        if private_tp_url is None:
            private_tp_url = "127.0.0.1:36749"
