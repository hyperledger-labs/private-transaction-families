...
generated_edge_files: $(SGX_EDGER8R) 
	$(SGX_EDGER8R) --untrusted $(Main_Dir)/Enclave/Enclave.edl --search-path $(Main_Dir)/Enclave --search-path $(SGX_SDK)/include --search-path $(SgxSsl_Dir)/include 
	@echo "GEN  =>  $@"

clean:
	@rm -f Enclave_u.h Enclave_u.c
