...
Listener_Enclave_Dir := $(Protected_Ledger_Root)/Listener/Enclave
...
Enclave_Include_Paths := -I. -I$(Common_Dir) -I$(Listener_Enclave_Dir) -I$(Main_Dir)/Enclave -I$(Crypto_Dir) -I$(SgxSsl_Dir)/include \
...
libacl.a: $(Main_Dir)/Enclave/Enclave_t.h $(Enclave_C_Objects)
	ar rcs libacl.a $(Enclave_C_Objects)
	@echo "ar =>  $@"

clean:
	@rm -f libacl.a $(Enclave_C_Objects)
