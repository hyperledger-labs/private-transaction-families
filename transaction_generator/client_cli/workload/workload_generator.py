        ...
        while True:
            ...
            with self._lock:
                ...
                if delta >= self._display_frequency:
                    ...
                    # if no transaction were submitted, probably problem with TP, stop stress
                    if self._submitted_batches_sample is not 0 and self._committed_batches_sample is 0:
                        LOGGER.error('No transaction commited for last %d seconds, stoping', delta)
                        self.stop()
